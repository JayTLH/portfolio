      ...
      <div className="contact" >
        ...
        <div className="contact__info">
          ...
          <div className="contact__logos">
            ...
            <a className="contact__link--one" href="https://resume.creddle.io/resume/r7k50mmwa" target="_blank" rel="noopener noreferrer"><img className="contact__link-img" src={resumeLogo} alt="resume logo" /></a>
