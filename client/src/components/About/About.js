  ...
  return (
    <div className="about">
      ...
      <div className="about__info">
        ...
        <p className="about__text">Toronto based web developer with a knack for solving problems<br />Constantly seeking new challenges<br />Dungeons and Dragons fan.</p>
      </div>
    </div>
  )
}
